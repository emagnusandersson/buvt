...
gThis.divTopCreator=function(el){
  ...
  el.myAppend(...ButTab, ' | ', linkWiki, ' | ', linkNotation, ' | ', butClear);  //, ' | ', linkS, ` ${charRightArrow} `, linkT, spanTData   , settingButton, , divNotations, ' | ', linkDb , ' ', linkAppFolder, ' | ', selectorOfTheme
...
gThis.viewFrontCreator=function(el){
  ...
  el.clearUI=function(){ 
    ...
    //miniViewRelationFixingS.clearUI(); miniViewHashMatchS.clearUI(); miniViewRelationFixingT.clearUI(); miniViewHashMatchT.clearUI()
  ...
  //gThis.divMid=
  var divMid=createElement('div').myAppend(divT2DBoth, el.divT2TUsingHash).css({display:'grid', 'grid-template-columns':'1fr auto', 'column-gap':'3px','margin-top':'0px', 'margin-bottom':'0px', flex:'0 0 auto'}); // , divCollisionSMW, 'grid-template-rows':'auto auto'
...
gThis.viewExtraCreator=function(el){
  ...
  var miniViewSettings=miniViewSettingsCreator(createElement('div'))
  ...
  var miniViewSMUnify=miniViewSMUnifyCreator(createElement('div'));
  var miniViewHashMatchDelete=miniViewHashMatchDeleteCreator(createElement('div'));

  var divMid=createElement('div').myAppend(miniViewSettings, miniViewProgramFolders, miniViewFilterMethodTester, miniViewEmptyFolder, miniViewSMUnify, miniViewHashMatchDelete)
