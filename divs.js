...
gThis.viewFrontCreator=function(el){
  ...
  el.setUIBasedOnSetting=async function(){
    ...
    else { var {strExtraTargetFolders}=result; }
    el.textarea.myText(strExtraTargetFolders) //+' ◂'
  ...
  var miniViewHashMatch=miniViewHashMatchCreator(createElement('div'), charSide)
  var divCollisionS=createElement('div').myAppend(miniViewSMMatch, miniViewHashMatch).css({'grid-area':'3/1'})
  ...
  el.textarea=createElement('textarea').attr({disabled:true})  //.attr({readonly:true})
  var divTextArea=createElement('div').myAppend('Extra Target folders: ', el.textarea).css({'grid-area':'1/1/span 1/span 2'})

  var charSide='T'
  var miniViewSMMatch=miniViewSMMatchCreator(createElement('div'), charSide)
  var miniViewHashMatch=miniViewHashMatchCreator(createElement('div'), charSide)
  var divCollisionT=createElement('div').myAppend(divTextArea, miniViewSMMatch, miniViewHashMatch).css({'grid-area':'3/2'});
  ...
  var divExtra=createElement('div').myAppend('Collision Checks').css({'grid-area':'2/1/span 1/span 2'})
  //gThis.divMid=
