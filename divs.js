...
gThis.viewExtraCreator=function(el){
  ...
  var miniViewHashMatchDelete=miniViewHashMatchDeleteCreator(createElement('div')).toggle(boExperiment)
  var miniViewReplacePrefix=miniViewReplacePrefixCreator(createElement('div'))

  var miniViewHashMatch=miniViewHashMatchCreator(createElement('div')).toggle(boExperiment)
