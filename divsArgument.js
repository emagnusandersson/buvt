...
gThis.getSelectedFrFile=async function(){
  ...
  //var fiTargetDataDir=fiTargetDbDir; if(flTargetDataDir) fiTargetDataDir+=charF+flTargetDataDir
  ...
  extend(objOptExtended, {objOptSource, objOptTarget, fiTargetDataDir})
...
gThis.calcExtraData=async function(arg){ // Extra calculations, caclulating fs from fi
  ...
  var argExtra={fsSourceDir, fsTargetDbDir, fsTargetDataDir, fsSourceDb, fsTargetDb, fleTargetDataDir} //, ArgSide
