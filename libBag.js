...
var rearrangeByBestNameMatch=function(relation){ 
  ...
  //var FitVal=Array(lenA)
  var FitVal=Array(lenA*lenB), nExact=0
...
// var nExact=rearrangeByBestNameMatch(arrA, arrB)
// debugger

var rearrangeByBestNameMatchArr=function(Relation){ // Note this function adds the property nExact to each relation
  for(var k in Relation){
    var relation=Relation[k]
    var nExact=rearrangeByBestNameMatch(relation)
    extend(relation,{nExact})
  }
}
