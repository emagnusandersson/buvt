...
// buvtDbB.txt (list of targetFolders)
// "CopyToTarget" should be right after "Deleted" (Unchanged on the top perhaps)
// strFsTarget should be FAT32/ext4
// In SM-collisions tRes-select-box should be defaulted to the lowest of source/target in the settings.
// T2T should be cleared when clicking T2D>compare
// Source/Target switch in miniViewHashMatchDeleteCreator ?!?!?
// tDiff column in hsmToChange.txt (in miniViewHashMatchCreator) (so you know how much the time is changed)
