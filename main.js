...
// Try using fs-apis with bigint timestamps
// When hovering links, the 10 first entries of the list should be shown
// Continue-button in bottom-bar.
// Settings: drag: scroll when close to top or bottom
// fsDir should be used instead of fsDirSource in SyncTreeToDb
// List/count soft links
// getStats doesn't work on remote (although not really used except in check (and maybe other places)).
