...
// var StemSMMult=["smMultHashConsistent", "collision1MToM"]

  // KeySingle: files that are written one at a time, but still devided into "S_" and "T_" version
var KeySingle=["hashMultSMNonConsistent", "collision1TM", "collisionMTM", "collision1MToM", "collision1T1_mult", "collisionMT1", 'hsmRevert', 'hsmToChange', 'smToChange', 'smReadOnly', 'notInDb']; //, 'smRevert', "hashMultSMConsistent", "smMultHashConsistent", 
...
gThis.calcFs=function(fsF){
  ...
  // gThis.pathSMMultHashNonConsistent=new MyTextFile(fsF, 'collision1MToM');
