...
gThis.locationTabExtend=function(el){
  ...
  el.setTLastSync=async function(id){
    debugger // This function is never used
  ...
  el.getHighestProp=function(key){ // Note! if dataset is used (which it's not), then this method should only be used with properties of type Number.
