...
// The pattern exists on both S and T and more than once on at least one of them. <br/>(read fr files)
  ...
  var divCollision=createElement('div').css({display:'grid', 'grid-template-columns':'1fr 1fr', 'column-gap':'3px','margin-top':'0px', 'margin-bottom':'0px', flex:'1 1 auto', 'overflow-y':'auto'}).myAppend(miniViewSMMatch, miniViewHashMatch)
