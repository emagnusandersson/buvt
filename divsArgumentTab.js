...
gThis.ArgumentTabRow={
  ...
  rDefault:{ind:0, boSelected:false, label:'', fiSourceDir:'', fiTargetDir:'', fiTargetDbDir:'', suffixFilterFirstT2T:'', charTResS:'9', charTResT:'9', tLastSync:0, tLastCheckS:0, tLastCheckT:0, strHostTarget:'', charFilterMethod:"b", boIncIdS:false, boIncIdT:false, boAllowLinks:true, boAllowCaseCollision:true, strFsTarget:'ext4'}, // , leafFilterFirst:'', leafDb:''
  factory:function(){
...
ms: all characters except ""*/:<>?\\|" (Microsoft (NTFS, exFAT, FAT32 (VFAT)))`
}
...
gThis.argumentSetPopExtend=function(el){
  ...
  var labTargetDir=createElement('div').myAppend('fiTargetDir').prop({title:StrHeaderTitle.fiTargetDir});
  ...
  var labFsTarget=createElement('div').myAppend('FsTarget').prop({title:StrHeaderTitle.strFsTarget});
  ...
  var Lab=[labLabel, labSourceDir, labTargetDir, labTargetDbDir, labFilterFirstT2T, labTResS, labTResT, labHostTarget, labFilterMethod, labIncIdS, labIncIdT, labAllowLinks, labAllowCaseCollision, labFsTarget];
  var Inp=[inpLabel, inpSourceDir, inpTargetDir, inpTargetDbDir, inpFilterFirstT2T, selTResS, selTResT, inpHostTarget, selFilterMethod, inpIncIdS, inpIncIdT, inpAllowLinks, inpAllowCaseCollision, selFsTarget];
  ...
  [inpSourceDir, inpTargetDir, inpTargetDbDir].forEach(ele=>ele.css({'margin-left':'0em', width:'-webkit-fill-available'}))
