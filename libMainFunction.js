...
class SyncTreeToDb{
  ...
  async compare(){
    ...
    extend(this, {arrSource, arrTarget, arrSourceUntouched, arrTargetUntouched, arrSourceChanged, arrTargetChanged, arrSourceIM, arrTargetIM, arrSourceNM, arrTargetNM, arrSourceReusedName, arrTargetReusedName, arrSourceReusedId, arrTargetReusedId, arrCreate, arrDelete, arrSource1T1NoName, arrTarget1T1NoName, arrSourceMultNoName, arrTargetMultNoName, ArrSourceMultNoName, ArrTargetMultNoName})
    ...
    //myResultWriter.Str["T2D_renamed"]=Category1T1.format(arrSourceIM, arrTargetIM)
    myResultWriter.Str["T2D_copiedThenRenamedToOrigin"]=CategoryT2DNM.format(arrSourceNM, arrTargetNM)
  ...
  async readAction(){
    ...
    extend(this, {arrUntouchedWOExactMTime, arrSourceChanged, arrTargetChanged, arrSourceIM, arrTargetIM, arrSourceNM, arrTargetNM, arrSourceReusedName, arrTargetReusedName, arrSourceReusedId, arrTargetReusedId, arrCreate, arrDelete, arrSource1T1NoName, arrTarget1T1NoName, arrSourceMultNoName, arrTargetMultNoName, ArrSourceMultNoName, ArrTargetMultNoName}) // arrSource, arrTarget, arrSourceUntouched, arrTargetUntouched
    return [null]
  }
  getMess(){
    var {arrTargetChanged, arrTargetIM, arrTargetNM, arrTargetReusedName, arrTargetReusedId, arrCreate, arrDelete, arrTarget1T1NoName, arrSourceMultNoName, arrTargetMultNoName}=this
  ...
  async doSCChanges(){ // SC=Short cut
    var {arrDb, arrUntouchedWOExactMTime, arrSourceChanged, arrTargetChanged, arrSourceIM, arrTargetIM, arrSourceNM, arrTargetNM, arrSourceReusedName, arrTargetReusedName, arrSourceReusedId, arrTargetReusedId, arrCreate, arrDelete, arrSource1T1NoName, arrTarget1T1NoName, arrSourceMultNoName, arrTargetMultNoName, ArrSourceMultNoName, ArrTargetMultNoName}=this
    // var [arrDbNonRelevant, arrDbRelevant]=selectFrArrDb(arrDb, flPrepend)
    // var arrDbOrg=arrDb, arrDb=arrDbRelevant
    // this.arrDb=arrDb;   this.arrDbNonRelevant=arrDbNonRelevant
  ...
  async createSyncData(){  // Calculate hashcodes etc
    ...
    var { arrSourceUntouched, arrTargetUntouched, arrSourceChanged, arrTargetChanged, arrSourceIM, arrTargetIM, arrSourceNM, arrTargetNM, arrSourceReusedName, arrTargetReusedName, arrSourceReusedId, arrTargetReusedId, arrCreate, arrDelete, arrSource1T1NoName, arrTarget1T1NoName, arrSourceMultNoName, arrTargetMultNoName, ArrSourceMultNoName, ArrTargetMultNoName}=this
