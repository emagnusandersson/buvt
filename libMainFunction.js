...
CopyOnTarget: ${nT} file${pluralS(nT)}`
  ...
  async makeChanges(){
    ...
    var strTmp=`Copying/renaming to temporary filenames ...`;  myConsole.printNL(strTmp)
    ...
    var strTmp=`copyToTarget ...`;  myConsole.printNL(strTmp)
    await copyToTarget.copy();

    var strTmp=`renameToFinal ...`;  myConsole.printNL(strTmp)
