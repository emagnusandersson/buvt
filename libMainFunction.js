...
class SyncDbI{
  ...
  async compare(){
    ...
    myResultWriter.Str.STMatch2=formatMatchingDataWMult(ArrSourceMMult, ArrTargetMMult); 
  ...
  async readAction(){
    ...
    var [err, , , arrSourceM1T1, arrTargetM1T1]=parseRelations(strData); if(err) return [err]
  ...
  async writeDb(){
    ...
    //var StrOut=formatListForFile(arrTargetNew, ...ObjKeyList['db']);
...
class SyncT2TUsingHash{
  ...
  async compare(){  //runOps
    ...
    extend(this, {categoryDelete, copyOnTarget1, moveOnTarget, moveOnTargetNSetMTime, categorySetMTime, copyToTarget, copyOnTarget2, nExactTot})
