...
class SMMultWork{
  constructor(){ }
  async getMult(arg){
    var {fiSourceDir, fiTargetDir, fiTargetDbDir, charTRes, strHostTarget, boRemote, charSide, FlExtraF}=arg;
...
class SyncDbI{
  ...
  async createSyncData(){  // Calculate hashcodes etc
    var {fsDir, fsDbDir, flPrepend, arrDbNonRelevant, strHost, boRemote}=this
...
class ExtraTargetFReaderWriter{
  constructor(arg){
    //var {fsTargetDir, fsTargetDbDir, strHostTarget}=arg
    copySome(this, arg, ["fsTargetDir", "fsTargetDbDir", "strHostTarget"]);
  }
  async read(flTargetF){
    var {fsTargetDir, fsTargetDbDir, strHostTarget}=this
    if(fsTargetDir==fsTargetDbDir) return [null]
  ...
  async write(){
    var {fsTargetDir, fsTargetDbDir, strHostTarget, FlF, FlExtraF}=this;
...
class SyncT2TUsingHash{
  constructor(arg){
    ...
    copySome(this, arg, ["fsSourceDir", "fsTargetDir", "fsTargetDbDir", "strHostTarget", "boRemote", "charFilterMethod", "boAllowLinks", "boAllowCaseCollision", "strFsTarget"]);
