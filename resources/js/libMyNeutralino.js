...
class MyConsole{
    ...
    cursorUp(){
      var indLastEnd=this.div.innerHTML.lastIndexOf('\n', this.indCur-1); if(indLastEnd==-1) return new Error('on top line');
    ...
    print(str) { this.div.innerHTML=this.div.innerHTML.slice(0,this.indCur)+str; this.setCur(); return this;}
    ...
    error(str) { 
      ...
      this.print(`<font style="color:red">Error: ${str}</font>\n`);
      return this;
    }
  }
