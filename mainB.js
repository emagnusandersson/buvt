...
var funLoad=async function(){
  ...
  var fsResultFolderTmp
  if(fiResultFolder) {
    var [err, fsResultFolderTmp]=await myRealPath(fiResultFolder); if(err){debugger; return [err]}
  }else fsResultFolderTmp=fsDataHome;
  gThis.fsResultFolder=fsResultFolderTmp
