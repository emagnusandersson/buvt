...
var funLoad=async function(){
  ...
  gThis.butClear=createElement('button').myAppend('C').prop({title:'Clear output console (and match results)'}).css({position: 'absolute', right: '0px', bottom:'0px', 'z-index':1}).on('click',  function(){
    myConsole.clear();
